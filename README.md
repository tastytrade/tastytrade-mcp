...
> about, and [Disclaimer](#disclaimer), [Disclosures](#disclosures) and
> [Notice](#notice) for what this software does and does not promise.
...
<!-- The text below is tastytrade's compliance-approved "tastytrade MCP Server
     Disclosures" and is reproduced verbatim. Do not reword, abridge, or
     reformat it. Raise any change with compliance first. The source PDF is at
     https://developer.tastytrade.com/disclosures/tastytrade-mcp-server-disclosures.pdf -->

The tastytrade Model Context Protocol (“MCP”) Server lets you connect a
third-party AI application or Large Language Model (“LLM”) (collectively, an
“AI System”) of your choosing to your tastytrade account(s) to research markets,
analyze your portfolio, and place orders in plain language. How you use your AI
System is up to you — from an interactive assistant where you review and confirm
each order, to an automated system you build and operate yourself. You are
responsible for how the server is configured and used, including any automated
or unattended trading conducted by or through your chosen AI System, and for all
orders placed from your account.

tastytrade does not endorse or recommend any third-party AI System, and
tastytrade is not responsible for any information, output, or trading activity
generated by or through your connected AI System. Any AI-generated information
should be independently verified. You are solely responsible for any actions
taken in reliance on information generated by your AI System and for any
investment or trading decisions made using it. You are responsible for
monitoring any activity undertaken by or through your AI System to ensure it is
operating as you intended. Once you share your account data with an AI System
provider you select, it leaves tastytrade's environment and is governed by that
provider's terms and privacy practices. tastytrade is not responsible for any
unauthorized access to your account data resulting from your usage of an AI
System.

AI Systems can make errors. They may misinterpret instructions, act on
incomplete or outdated information, or produce analysis that is inaccurate or
unsuitable for you. You are solely responsible for reviewing all your
AI-generated output, orders, and account activity. tastytrade does not guarantee
the accuracy, completeness, or suitability of any of your AI-generated output.

Trading securities, options, and futures involves significant risk and is not
suitable for all investors; you may lose more than your initial investment.
Before trading options, read the
[Characteristics and Risks of Standardized Options](https://assets.tastyworks.com/production/documents/USA/characteristics_and_risks_of_standardized_options.pdf)
and
[Futures & Exchange-Traded Options Risk Disclosure Statement](https://assets.tastyworks.com/production/documents/USA/futures_exchange_traded_options_risk_disclosure_agreement.pdf).
We recommend testing with paper trading before connecting a live account.

tastytrade, Inc. is a registered broker-dealer and a member of FINRA, NFA, and
SIPC.

**Disclosures:** [tastytrade MCP Server — Disclosures (PDF)](https://developer.tastytrade.com/disclosures/tastytrade-mcp-server-disclosures.pdf)
